...
//##############################################################################
	...
	public function admin_menu() {
		...
		if ( commentpress_is_legacy_plugin_active() ) {
			...
			// show on pages other than the Commentary Sandbox  admin page
			if (
	...
	public function migrate_alert() {
		...
		// show it
		echo '<div id="message" class="error"><p>' . __( 'Commentary Sandbox  has detected that a previous version of CommentPress is active on this site. Please visit the <a href="options-general.php?page=commentpress_admin">Settings Page</a> to upgrade.', 'Commentary Sandbox ' ) . '</p></div>';
	...
	public function get_deactivate_element() {
		...
		return '
		<tr valign="top">
			<th scope="row"><label for="cp_deactivate_commentpress">' . __( 'Deactivate Commentary Sandbox ', 'Commentary Sandbox ' ) . '</label></th>
