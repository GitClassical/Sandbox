...
Plugin Name: Commentary Sandbox 6.8

Plugin URI: http://www.futureofthebook.org/commentpress/

Description: “CommentarySandbox” is a modification of the <a href="http://futureofthebook.org/commentpress/">CommentPress plugin</a> by the Institute for the <a href="http://www.futureofthebook.org/">Future of the Book</a>. It allows users to create a simple <a href="http://dcc.dickinson.edu/">DCC-style</a>  digital commentary. 
...
Eddie Tejeda @ http://www.visudo.com for CommentPress 2.2
...
function commentpress_plugin_action_links( $links, $file ) {
	...
	if ( $file == plugin_basename( dirname( __FILE__ ) . '/commentpress-core.php' ) ) {
		...
		$links[] = '<a href="' . esc_url( $link ) . '">' . esc_html__( 'Settings', 'CommentarySandbox' ) . '</a>';
...
if (
	...
	register_activation_hook( COMMENTPRESS_PLUGIN_FILE, array( $commentpress_core,'create_plugin_database_table') );
